...
/// This class is responsible for checking Git and git-tfs installations.
/// </summary>
/// <remarks>
...
public static class RequiredModulesChecker
{
    ...
    /// </summary>
    /// <param name="requireGitTfs">Whether git-tfs is required (true for TFVC migrations)</param>
